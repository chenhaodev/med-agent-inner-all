...
> 状态快照：2026-06-07。P0 eval 已重跑（18:28–18:46），真实 v3 数字已更新。

---

## ✓ P0 完成：v3 指标已用真实数字刷新

patient **37.9/40 · 92.8%** / doctor **37.9/40 · 89.1%**，eval 耗时 ~13 min（并发 8）。含 generation max_tokens + P2 证据计数修复后的最终数字。
