...
KW_RESPIRATORY_LUNG_TUMOR="肺癌|肺部肿瘤|非小细胞肺癌|NSCLC|小细胞肺癌|SCLC|肺腺癌|肺鳞癌|EGFR.*肺|肺结节.*恶性|LDCT.*筛查|肺癌筛查"
...
KW_DIGESTIVE_GI="胃炎|消化性溃疡|胃溃疡|十二指肠溃疡|幽门螺杆菌|HP感染|消化不良"
...
# 肾
KW_RENAL_CKD="慢性肾病|CKD|慢性肾功能不全|肾功能减退|肌酐升高|肾小球滤过率|eGFR|蛋白尿"
...
KW_INFECTIOUS_FEVER="不明原因发热|FUO|发热待查|疟疾|伤寒|布鲁氏菌|旅行.*发热|回国.*发热|热带.*发热"
