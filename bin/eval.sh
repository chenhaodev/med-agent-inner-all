...
export ROOT_DIR LIMIT FILTER_ID DEEPSEEK_API_KEY DEEPSEEK_MODEL
...
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo " 西氏内科精要 家属问答 Eval — $(date '+%Y-%m-%d %H:%M:%S')"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
...
")
  ...
  MODEL_RESPONSE=$("$SCRIPT_DIR/build_prompt.sh" "$DOMAINS" "$QTEXT" | \
